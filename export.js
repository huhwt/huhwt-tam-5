...
function getParameters()
{
    let params =
    {
        ...
        "PARAM_ACTIVE_LOCALE" : PARAM_ACTIVE_LOCALE
    };
    ...
    for (const [key, value] of Object.entries(params))
    {
        switch (key)
        {
            ...
            case "PARAM_SHOW_TOOLTIPS":
                ...
                break;
            case "PARAM_SHOW_YEARVALUES":
                PARAM_SHOW_YEARVALUES = false;
                break;
            ...
            case "PARAM_SOURCE_FILE":
                ...
                break;
            case "PARAM_ACTIVE_LOCALE":
                PARAM_ACTIVE_LOCALE = value;
                break;
